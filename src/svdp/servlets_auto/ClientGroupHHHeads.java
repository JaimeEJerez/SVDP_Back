...
/**
 * Servlet implementation class ClientGroupHouseHoldHeads
 */
@WebServlet("/ClientGroupHHHeads")
public class ClientGroupHHHeads extends APIEntryPoint 
{
	...
	{		
		...
		String query1 = "SELECT HauseholdheadEmail FROM ClientGroupHHHeads;";
		String query2 = "SELECT Email, CONCAT( \"Name\", \" \", LastName ) AS Name FROM Hauseholdheads WHERE Validated IS NOT NULL AND HelpApproveDate IS NOT NULL;";
		...
		catch (Exception e )
		{
			...
			gson.toJson( JSONResponse.not_success( 1087, e.getMessage() ), osw );
