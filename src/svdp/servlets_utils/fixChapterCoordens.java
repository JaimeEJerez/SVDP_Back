 ...
 */
@WebServlet("/fixChapterCoordens")
public class fixChapterCoordens extends HttpServlet 
{
	...
	{		
		...
		try
		{
			String query = "SELECT ChapterID, LON, LAT, Zip_Code FROM Chapters;";
				...
				public boolean execute( ResultSet rs, int rowCount, int columnNumber, Object linkObj ) throws SQLException, IOException 
				{
					...
					if ( lon == null || lat == null )
					{
						...
						if ( resultVect2 != null && resultVect2.size() == 2 )
						{
							...
							String command = "UPDATE Chapters SET LON=" + lon + ", LAT=" + lat + " WHERE ChapterID=" + cid;
			...
			else
			{
				...
				resultMap.put( "nNotFoundZCd=", String.valueOf( nNotFoundZCd ) );
