...
/**
 * Servlet implementation class GetVoluntiersGroupsInvitedToEvents
 */
@WebServlet("/GetVoluntiersGroupsInvitedToEvents")
public class GetVoluntiersGroupsInvitedToEvents extends HttpServlet 
{
     ...
     */
    public GetVoluntiersGroupsInvitedToEvents() 
    {
        super();
    }
	...
	{		
	    ...
	    if ( eventName == null )
	    {
			gson.toJson( JSONResponse.not_success( 1182, "EventName parameter is null" ), osw );
		...
		try
		{
			...
			{
				Hashtable<String,String> resultmap = DoGetVoluntiersGroupsInvitedToEvents( mySQL, eventName );
	...
	public static Hashtable<String,String> DoGetVoluntiersGroupsInvitedToEvents( MySQL mySQL, String eventName )
	{
		String query1 = "SELECT HelpGroupName FROM HelpGroups ORDER BY HelpGroupName;";
		String query2 = "SELECT HelpGroupName FROM VoluntiersGroupsInvitedToEvents WHERE EventName=\"" + eventName + "\"" ;
